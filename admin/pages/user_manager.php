    ...
    $.ajax ({
      ...
      success: function(data) {
        if(data == 'fail') {
          ...
          var user = '<p>ID: ' + myarray[0] + '</p><p>Email: ' + myarray[1] + '</p><p>Nickname: ' + myarray[2] + '</p><p>Reg.Date: ' + myarray[3] + '</p><p>Root: ' + myarray[4] + '<select id="root" name="root"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option></select></p>';
          $("#wrapper").html(user);
        }
        }
